...
_DOC_EMBEDDINGS_LAYER_NAME = 'doc_embeddings'
...
class DBOW(object):
    ...
    def build(self):
        ...
        embedded_doc = Embedding(input_dim=self._num_docs,
                                 ...
                                 input_length=1,
                                 name=_DOC_EMBEDDINGS_LAYER_NAME)(doc_input)
      
        softmax = Dense((self._window_size, self._vocab_size), activation='softmax')(embedded_doc)
